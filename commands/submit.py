...
async def submit_impl(ctx, bot, platform, game, record, evidence, attachment, botInfo, users, db_json, queue_json, queue):
    ...
    if platform_IGN == "":
        await ctx.respond(f"You haven't connected your {platform.name} account yet!")
        return
